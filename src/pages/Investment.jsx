...
import { 
  TrendingUp, Shield, Clock, DollarSign, Building2, BarChart3, 
  Target, Award, ChevronRight, Calendar, Users, MapPin, 
  CheckCircle, Star, Filter, Search, 
  Phone, Mail, Download, Eye, Heart,
  Zap, PieChart,TrendingUpIcon
} from 'lucide-react';
...
const Investment = () => {
  ...
  const investmentProjects = [
    {
      ...
      funded: 75,
      investors: 42,
      features: ['Garanti locatif', 'Gestion incluse', 'TVA réduite', 'Clé en main'],
    ...
    },
    {
      ...
      funded: 60,
      investors: 38,
      features: ['Bail longue durée', 'Prime location', 'Indexation loyer', 'Services premium'],
      popularity: 'Élevée',
      status: 'En cours'
    },
    {
      ...
      funded: 92,
      investors: 65,
      features: ['Rendement garanti', 'Promoteur certifié', 'Livraison 2025', 'Épargne défiscalisée'],
      popularity: 'Très élevée',
    ...
    },
    {
      ...
      funded: 45,
      investors: 28,
      features: ['Anchors confirmés', 'Revenus stables', 'Gestion professionnelle', 'Prime risque'],
      popularity: 'Moyenne',
      status: 'Nouveau'
    },
    {
      ...
      funded: 88,
      investors: 24,
      features: ['Segment premium', 'Clientèle internationale', 'Services conciergerie', 'Plus-value élevée'],
      popularity: 'Élevée',
      status: 'En cours'
    },
    {
      ...
      funded: 70,
      investors: 55,
      features: ['Demande garantie', 'Gestion simplifiée', 'Résilience crise', 'Croissance forte'],
      popularity: 'Très élevée',
      status: 'Nouveau'
    }
  ];
  ...
  const investmentStats = [
    { label: "Rendement moyen", value: "7.2%", icon: <TrendingUp size={28} />, trend: '+0.4%', color: 'emerald' },
    { label: "Investissements sécurisés", value: "100%", icon: <Shield size={28} />, trend: 'Garanti', color: 'blue' },
    { label: "Durée moyenne", value: "6.2 ans", icon: <Clock size={28} />, trend: 'Stable', color: 'purple' },
    { label: "Ticket minimum", value: "25k€", icon: <DollarSign size={28} />, trend: 'Accessible', color: 'amber' },
    { label: "Projets financés", value: "45+", icon: <Building2 size={28} />, trend: 'En croissance', color: 'indigo' },
    { label: "Investisseurs actifs", value: "1,200+", icon: <Users size={28} />, trend: '+15%', color: 'rose' }
  ];
  ...
  const benefits = [
    {
      ...
      features: ['Due diligence complète', 'Garanties bancaires', 'Assurances projet']
    },
    {
      icon: <BarChart3 size={32} />,
      title: 'Rendement optimisé',
      description: 'Performance supérieure grâce à notre expertise',
      features: ['Étude de marché approfondie', 'Optimisation fiscale', 'Gestion active']
    },
    {
      icon: <Target size={32} />,
    ...
    },
    {
      ...
      features: ['Plateforme digitale', 'Documentation claire', 'Paiement sécurisé']
    }
  ];

  const successStories = [
    { name: 'Pierre D.', investment: '75,000€', duration: '3 ans', roi: '42%', project: 'Résidence Les Harmonies' },
    { name: 'Sophie M.', investment: '120,000€', duration: '5 ans', roi: '68%', project: 'Tour des Affaires' },
    { name: 'Thomas R.', investment: '50,000€', duration: '2 ans', roi: '31%', project: 'Student Residence' }
  ];
  ...
  const filteredProjects = investmentProjects.filter(project => {
    if (activeFilter !== 'tous' && !project.type.toLowerCase().includes(activeFilter.toLowerCase())) {
      return false;
    }
    if (searchTerm) {
    ...
    switch (sortBy) {
      case 'roi_desc': return parseFloat(b.roi) - parseFloat(a.roi);
      case 'roi_asc': return parseFloat(a.roi) - parseFloat(b.roi);
      case 'min_invest': return a.minInvestment - b.minInvestment;
      case 'popularity': return b.funded - a.funded;
      default: return 0;
    }
  });
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-purple-100 mb-8 leading-relaxed">
              Investissez dans l'immobilier avec des rendements supérieurs et une sécurité maximale. 
              Nos projets sont sélectionnés et audités pour votre réussite.
            </p>
        ...
        <div className="relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transform -translate-y-1/2">
            <div className="grid grid-cols-2 lg:grid-cols-6 gap-4">
              {investmentStats.map((stat, index) => (
                <div key={index} className="bg-white rounded-2xl shadow-2xl p-6 hover:shadow-3xl transition-all duration-300 hover:-translate-y-1">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className={`text-xs font-semibold px-2 py-1 rounded-full ${
                      ...
                      stat.trend.includes('-') ? 'bg-rose-100 text-rose-700' :
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Une approche unique combinant expertise immobilière et optimisation financière
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-12">
            <div>
              ...
              <p className="text-gray-600">{filteredProjects.length} projet{filteredProjects.length !== 1 ? 's' : ''} disponible{filteredProjects.length !== 1 ? 's' : ''}</p>
            </div>
          ...
          <div className="flex overflow-x-auto gap-2 mb-8 pb-4">
            {['tous', 'locatif', 'bureaux', 'commercial', 'luxe', 'étudiant'].map((filter) => (
              <button
                key={filter}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
            {filteredProjects.map((project) => {
              ...
              const annualReturn = calculateAnnualReturn(project.minInvestment, project.roi);

              return (
                <div key={project.id} className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100">
                  <div className="relative h-56 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4 flex gap-2">
                      <span className={`px-3 py-1.5 rounded-full text-sm font-bold text-white ${
                        project.status === 'Bientôt complet' ? 'bg-gradient-to-r from-amber-500 to-amber-600' :
                        project.status === 'Nouveau' ? 'bg-gradient-to-r from-blue-500 to-blue-600' :
                    ...
                    <div className="absolute top-4 right-4 flex flex-col gap-2">
                      <button onClick={() => toggleFavorite(project.id)} className={`p-2.5 rounded-full backdrop-blur-sm transition-all ${isFavorite ? 'bg-rose-500 text-white' : 'bg-white/90 text-gray-700 hover:bg-white'}`}>
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      <div className="mb-2">
                        ...
                        <div className="w-full bg-white/30 rounded-full h-2">
                          <div className="bg-gradient-to-r from-emerald-400 to-emerald-500 h-2 rounded-full transition-all duration-1000" style={{ width: `${project.funded}%` }}></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-gray-900 group-hover:text-purple-600 transition-colors mb-2">{project.title}</h3>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-6 pb-6 border-b border-gray-100">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-emerald-600 mb-1">{project.roi}</div>
                        <div className="text-xs text-gray-600">Rendement</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-gray-900 mb-1">{formatPrice(project.minInvestment)}</div>
                        <div className="text-xs text-gray-600">Ticket min</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-gray-900 mb-1">{project.duration}</div>
                    ...
                    <div className="mb-6">
                      <div className="flex flex-wrap gap-2">
                        {project.features.slice(0, 3).map((feature, idx) => (
                          <span key={idx} className="inline-flex items-center gap-1 px-3 py-1.5 bg-purple-50 text-purple-700 rounded-full text-xs">
                            <CheckCircle size={12} />
                            {feature}
                          </span>
                        ))}
                    ...
                    <div className="space-y-4">
                      <div className="text-center p-3 bg-gray-50 rounded-xl">
                        <div className="text-sm text-gray-600 mb-1">Retour annuel estimé</div>
                        <div className="text-lg font-bold text-gray-900">{annualReturn}</div>
                      </div>
          ...
          {filteredProjects.length === 0 && (
            <div className="text-center py-20">
              ...
              <h3 className="text-3xl font-bold text-gray-900 mb-4">Aucun projet ne correspond à votre recherche</h3>
              <p className="text-gray-600 mb-8 max-w-md mx-auto">Essayez de modifier vos critères ou contactez-nous pour des opportunités personnalisées</p>
              <button onClick={() => { setActiveFilter('tous'); setSearchTerm(''); }} className="px-8 py-3.5 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">Découvrez les succès de nos investisseurs</p>
          </div>
              ...
              <div key={index} className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 shadow-lg border border-gray-100">
                <div className="flex items-center mb-6">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-gray-600">Investisseur depuis 3 ans</p>
                  </div>
                </div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex justify-between items-center p-3 bg-gradient-to-r from-emerald-50 to-emerald-100 rounded-xl">
                    ...
                    <span className="text-lg font-bold text-emerald-700">{story.roi}</span>
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-gray-50 rounded-xl p-3">
                      <div className="text-xs text-gray-600 mb-1">Investissement</div>
                      <div className="font-bold text-gray-900">{story.investment}</div>
                    </div>
                    <div className="bg-gray-50 rounded-xl p-3">
                      <div className="text-xs text-gray-600 mb-1">Durée</div>
                      <div className="font-bold text-gray-900">{story.duration}</div>
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-purple-100 mb-10 leading-relaxed">
              Rejoignez plus de 1,200 investisseurs satisfaits et bénéficiez de notre expertise
            </p>
