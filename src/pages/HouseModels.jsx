  ...
  useEffect(() => {
    ...
    const loadModels = async () => {
      try {
        ...
        if (isMounted) {
          setError("Impossible de charger les modèles de maison.");
        }
      } finally {
        if (isMounted) {
          setLoading(false);
    ...
    <div className="min-h-screen bg-slate-100">
      <section className="pt-24 pb-10 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl sm:text-5xl font-bold text-slate-900">
            Nos modèles de maison
          </h1>
          <p className="mt-4 text-lg text-slate-600 max-w-3xl">
            Decouvrez des modèles personnalisables, connectés et evolutifs,
            avec une présentation détaillée pour chaque gamme.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          ...
          <EmptyState
            title="Aucun modèle disponible pour le moment." />
                ...
                <div
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="space-y-3 text-slate-700 text-lg leading-relaxed">
                      ...
                      <p>Description détaillée non renseignee.</p>
                      }
                    </div>
