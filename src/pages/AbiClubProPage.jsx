...
const proClubIntro = [
"Le Club Pro ABI rassemble des professionnels, opérateurs et partenaires qui souhaitent évoluer dans un cadre plus structuré autour de l'immobilier, de la construction et de l'investissement.",
"L'objectif est de faciliter les mises en relation, rendre les opportunités plus lisibles et permettre à chaque membre de s'integrer dans un ecosysteme plus utile, plus qualifié et plus cohérent."];


const proClubObjectives = [
"Faciliter l'accès à des opportunités d'investissement qualifiées.",
...
"Accès prioritaire aux projets et due diligences preselectionnees.",
"Sessions de matchmaking cible avec porteurs de projets et co-investisseurs.",
"Invitations exclusives à des événements, masterclasses et visites de sites.",
"Bulletins d'opportunités et analyses de marché périodiques.",
"Accès à un repertoire d'experts : technique, juridique, financier, ESG."];
...
"Missions d'étude et visites de projets sur le terrain."];


const membershipItems = [
"Conditions : profil lié aux secteurs de la construction, des infrastructures, de l'investissement, du développement ou à un intérêt fort pour l'ecosysteme ABI.",
"Modalités : inscription via la plateforme, evaluation par l'équipe ABI et orientation selon le format d'adhésion le plus adapté.",
"Pourquoi rejoindre : accélérer l'accès à des deals de qualité, partager l'expertise et s'inscrire dans un réseau plus structuré."];


const membershipCards = [
{
  title: "Conditions",
  text: "profil lié aux secteurs de la construction, des infrastructures, de l'investissement, du développement ou à un intérêt fort pour l'ecosysteme ABI.",
  icon: FileBadge2
},
{
  title: "Modalités",
  text: "inscription via la plateforme, evaluation par l'équipe ABI et orientation selon le format d'adhésion le plus adapté.",
  icon: Settings2
},
{
  title: "Pourquoi rejoindre",
  text: "accélérer l'accès à des deals de qualité, partager l'expertise et s'inscrire dans un réseau plus structuré.",
  icon: Sparkles
}];
...
{
  value: "Reseau",
  label: "Mieux connecter les membres, expertises et opportunités ABI."
},
{
  value: "Lisibilite",
  label: "Rendre les projets, les rencontres et les bénéfices plus clairs."
},
{
  value: "Partenariats",
...
const subscriptionPlans = {
  investisseur: {
    ...
    items: [
    "Accès à une information plus lisible sur les opportunités ABI.",
    ...
    "Veille sur les projets, actualités et temps forts du club.",
    "Demande d'adhésion simplifiee avec accompagnement ABI."]
  ...
  entreprises: {
    ...
    "Visibilité accrue dans l'ecosysteme professionnel ABI.",
    "Accès à des rencontres et formats de networking plus qualifiés.",
    "Cadre utile pour les partenariats, collaborations et dealflow.",
    "Demande de souscription préparée avec l'équipe ABI."]
...
const AbiClubProPage = () => {
  ...
  const handleMembershipSubmit = (event) => {
    ...
    const subject = `Demande d'adhésion Club Pro - ${currentPlan.label}`;
    const body = [
  ...
  return (
    <div className="bg-[linear-gradient(180deg,#f4f7fb_0%,#f7f1e8_42%,#ffffff_100%)] text-slate-900">
      <PropertiesHero
        ...
        secondaryIcon={Mail}
        title="Club Pro ABI, un cadre clair pour connecter réseau, projets et opportunités."
        descriptionLines={[
        "Africa Build Investment reunit professionnels, operateurs et partenaires dans un club pense pour structurer les rencontres, les collaborations et les opportunités."]
        }
        ...
        <div className="mx-auto max-w-[1180px] px-6 py-14 sm:px-10 lg:px-8 lg:py-16">
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            <div className="max-w-[560px]">
              <h1 className="text-3xl font-semibold leading-tight text-slate-950 sm:text-4xl lg:text-[1.8rem]">
          ...
          <div className="grid gap-2 self-stretch">
            <div className="pb-4">
              ...
              <p className="mt-4 text-sm leading-7 text-slate-600 sm:text-base">
                Vous avez un conseiller dédié qui vous propose des projets adaptés à vos besoins.
                Idéal quand le temps manque ou que le marché est complexe.
                Accès complet au catalogue, inscription gratuite.
              </p>
            </div>
            ...
            <div className="mt-10 grid gap-6 border-t border-slate-300/80 pt-8 lg:grid-cols-[1fr_auto] lg:items-center">
              <div className="max-w-[760px]">
                <h3 className="text-2xl font-semibold leading-tight text-slate-950 sm:text-[2rem]">
                  Rejoindre un réseau plus structuré pour mieux lire les opportunités et activer les bonnes connexions.
                </h3>
                <p className="mt-4 text-sm leading-7 text-slate-600 sm:text-base">
                  ABI peut vous orienter sur les modalités d'adhésion, les rencontres du club et la facon d'integrer l'ecosysteme selon votre profil.
                </p>
              </div>
            ...
            <div className="grid lg:grid-cols-[0.9fr_1.1fr]">
              ...
              <form onSubmit={handleMembershipSubmit} className="bg-[#f7f9fc] px-6 py-8 sm:px-8">
                ...
                <label className="mt-5 block">
                  ...
                  placeholder="Precisez votre profil, votre intérêt pour le club et ce que vous recherchez." />
