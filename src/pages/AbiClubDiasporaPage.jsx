...
const diasporaIntro = [
"Le Club Deal Diaspora reunit des membres de la diaspora africaine souhaitant investir ensemble dans des projets d'infrastructure, d'immobilier et de développement local en Afrique.",
"L'objectif est d'offrir un cadre plus lisible, plus collectif et plus sécurisé pour canaliser l'epargne, structurer les véhicules d'investissement et accompagner les projets a impact."];


const diasporaObjectives = [
"Canaliser l'epargne de la diaspora vers des projets viables et transparents.",
"Structurer des véhicules d'investissement : fonds ou SPV adaptés aux besoins locaux.",
...
"Accès à des deals preselectionnes et co-investissements sécurisés.",
"Due diligence consolidee et conseil en structuration financiere.",
"Gouvernance claire et reporting régulier sur performance et impact.",
"Reduction des risques via syndication et partenariats locaux.",
"Événements dédiés, webinaires et rencontres de networking."];


const diasporaOperations = [
"Selection et présélection de projets par l'équipe Africa Build Investment.",
"Mise en place de structures juridiques et financieres pour chaque deal.",
"Gouvernance participative avec comité d'investissement et reporting trimestriel.",
"Options d'investissement flexibles : ticket individuel, co-investissement, fonds."];


const diasporaValueItems = [
{
  title: "1. Choisissez une opportunité d'investissement",
  subtitle:
...
"Profil d'investisseur : resident de la diaspora ou soutien avere au développement local.",
"Processus de KYC/AML, validation par le comite et engagement financier minimal par deal selon l'opportunite.",
"Pourquoi rejoindre : permettre à la diaspora d'investir de maniere collective, sécurisée et impactante tout en contribuant au développement durable des territoires d'origine."];


const membershipCards = [
{
  title: "Profil d'investisseur",
  text: "resident de la diaspora ou soutien avere au développement local.",
  icon: FileBadge2
},
{
  title: "Processus",
...
},
{
  ...
  text: "permettre à la diaspora d'investir de maniere collective, sécurisée et impactante tout en contribuant au développement durable des territoires d'origine.",
  icon: Sparkles
}];
...
{
  value: "Collectif",
  label: "Investir ensemble dans un cadre plus structuré"
},
{
  value: "Impact",
  label: "Relier rendement, utilité locale et gouvernance"
},
{
  value: "Visibilité",
  label: "Mieux lire les dossiers, les risques et les étapes"
},
{
...
const diasporaTrustCards = [
{
  ...
  text: "Investissez dans des projets immobiliers a fort potentiel avec une lecture plus claire des revenus, des loyers et de la création de valeur.",
  icon: TrendingUp
},
{
  title: "Une selection plus exclusive",
  text: "Les dossiers presentes passent par un cadre de lecture plus exigeant pour mieux filtrer les opportunités et reduire l'incertitude.",
  icon: FileBadge2
},
{
  title: "100% digital et sécurisé",
  text: "Le parcours d'adhésion, le suivi des dossiers et les échanges sont pensés pour rester fluides, même à distance depuis la diaspora.",
  icon: Shield
},
{
  title: "Une expérience terrain",
...
const AbiClubDiasporaPage = () => {
  ...
  const handleMembershipSubmit = (event) => {
    ...
    const subject = "Demande d'adhésion Club ABI Diaspora";
    const body = [
    ...
    `Capacité d'investissement : ${membershipForm.investmentCapacity || "Non renseignee"}`,
    "",
    "Message :",
  ...
  return (
    <div className="bg-[linear-gradient(180deg,#f4f7fb_0%,#f7f1e8_42%,#ffffff_100%)] text-slate-900">
      <PropertiesHero
        ...
        secondaryIcon={Mail}
        title="Trouver des opportunités et de réels avantages."
        descriptionLines={[
          ...
          <div className="grid gap-2 self-stretch">
            <div className="pb-4">
              ...
              <p className="mt-4 text-sm leading-7 text-slate-600 sm:text-base">
                À partir de 100 euros, investissez dans des projets immobilier a fort rendement et percevez chaque mois une part des loyers et la plus-value à la revente.
              </p>
            </div>
        ...
        <div className="relative mx-auto max-w-[1180px] px-6 py-14 sm:px-10 lg:px-8 lg:py-18">
          <div className="mx-auto max-w-[860px] text-center">
            <h2 className="mt-4 text-2xl font-semibold leading-tight tracking-[-0.03em] sm:text-[2rem]">
              Investir en immobilier n'a jamais été aussi facile
            </h2>
            <p className="mt-4 text-sm leading-7 text-white/85 sm:text-base">
              Réaliser votre premier investissement en quatre étapes simple.
            </p>
      ...
      {/*
           Section Conditions d'adhésion à retravailler.
            ...
            <div className="grid lg:grid-cols-[0.9fr_1.1fr]">
              ...
              <form onSubmit={handleMembershipSubmit} className="bg-[#f7f9fc] px-6 py-8 sm:px-8">
                ...
                <div className="mt-5 grid gap-5 sm:grid-cols-2">
                  ...
                  <label className="block">
                    <span className="text-sm font-medium text-slate-700">Capacité d'investissement</span>
                    <input
                    type="text"
                    ...
                    onChange={handleMembershipFormChange}
                    className={inputClassName}
                    placeholder="Ex. à partir de 100 euros" />
                ...
                <label className="mt-5 block">
                  ...
                  placeholder="Precisez votre profil, votre intérêt pour le club et vos objectifs d'investissement." />
        ...
        <div className="mx-auto max-w-[1180px] px-6 py-14 sm:px-10 lg:px-8 lg:py-18">
          <div className="max-w-[860px]">
            ...
            <p className="mt-4 max-w-[760px] text-sm leading-7 text-slate-600 sm:text-base">
              Des projets mieux cadres, des opportunités plus lisibles et un accompagnement plus concret pour investir sereinement depuis la diaspora.
            </p>
          </div>
          ...
          <div className="bg-[linear-gradient(135deg,#0a67cf_0%,#0452ac_42%,#033c87_100%)] px-6 py-8 text-white shadow-[0_16px_36px_rgba(15,23,42,0.08)] lg:px-8">
            <div className="max-w-[760px]">
              <h2 className="text-2xl font-semibold leading-tight sm:text-[2rem]">
                Rejoindre un cadre collectif plus sérieux pour étudier, structurer et suivre les investissements de la diaspora.
              </h2>
            </div>

            <p className="mt-4 max-w-[760px] text-sm leading-7 text-white/82 sm:text-base">
              ABI peut vous orienter sur les modalités d'adhésion, la documentation attendue et le type d'opportunités accessibles dans le Club ABI Diaspora.
            </p>
