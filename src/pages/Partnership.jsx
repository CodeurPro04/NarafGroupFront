...
const partnerTypes = {
  immobilier: {
    ...
    certificationsLabel: "Références, agrements ou zones couvertes",
    certificationsPlaceholder:
    "Carte professionnelle\nZones d'intervention\nPromotions déjà commercialisees",
    descriptionLabel: "Présentation de votre activité immobilière",
    descriptionPlaceholder:
    "Decrivez votre positionnement, vos typologies de biens, votre couverture géographique et la valeur ajoutee de votre équipe.",
    icon: Building2
  },
  constructeur: {
    key: "constructeur",
    ...
    helper:
    "Pour les entreprises de construction, maîtres d'œuvre, BET, artisans et équipes chantier.",
    servicesLabel: "Corps de métier, expertises ou prestations proposees",
    servicesPlaceholder:
    "Construction gros oeuvre\nSecond oeuvre\nMaîtrise d'œuvre\nBureau d'études techniques",
    certificationsLabel: "Certifications, références chantier ou zones d'intervention",
    certificationsPlaceholder:
    "Certifications qualité\nProjets livres\nMateriel et capacites chantier",
    descriptionLabel: "Présentation de votre activité construction",
    descriptionPlaceholder:
    "Présentez vos spécialités, vos équipes, vos références chantier, vos capacités de mobilisation et votre approche qualité/ESG.",
    icon: Hammer
  },
  financier: {
    key: "financier",
    ...
    descriptionLabel: "Présentation de votre activité financière",
    descriptionPlaceholder:
   ...
   <section className="px-4 pb-16 sm:px-6 lg:px-8 lg:pb-24">
    <div className="mx-auto max-w-4xl">
     <div className="mb-6 text-center">
      ...
      <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-slate-600 sm:text-base">
       {currentType ?
              ...
              `Le formulaire est configure pour un partenaire ${currentType.shortTitle.toLowerCase()} et creera automatiquement votre compte entreprise à la soumission.` :
     ...
     {authenticated && !isCompany ?
       ...
       Vous etes connecté avec un compte non entreprise. Deconnectez-vous si vous souhaitez créer un nouveau compte partenaire depuis ce formulaire.
      </div> :
          null}
     ...
     {!authenticated ?
       ...
       <p className="text-lg font-semibold sm:text-xl">
        Votre compte entreprise sera créé automatiquement à partir de l'email renseigne dans ce formulaire.
       </p>
       <p className="mt-2 text-sm leading-7 text-slate-600">
        Une fois la demande envoyee, un mot de passe temporaire s'affichera pour votre première connexion. L'activation finale reste soumise à la validation de l'administrateur.
       </p>
      </div> :
          null}
     ...
     {!currentType ?
       ...
       <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
        ...
        <Field label="Site web ou page de présentation">
         <input
                  type="text"
                  name="website"
        ...
        <p className="text-center text-xs leading-6 text-slate-500 sm:text-left">
         {authenticated && isCompany ?
           ...
           ABI transmet votre candidature avec le type <span className="font-semibold text-slate-700">{currentType.backendValue}</span>.
                ...
                <>
           ABI creera votre compte entreprise à partir de l'email <span className="font-semibold text-slate-700">{formData.email || "professionnel"}</span>, puis soumettra votre dossier a validation administrateur.
          </>
                }
        </p>
        <button
