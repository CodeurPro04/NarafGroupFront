...
import { Search, MapPin, Home, ChevronLeft, ChevronRight, TrendingUp } from 'lucide-react';
...
const Hero = () => {
  ...
  const [propertyTypes, setPropertyTypes] = useState([{ value: '', label: 'Type de bien' }]);
  ...
  const budgetRanges = [
    { value: '', label: 'Budget' },
    { value: '0-100000', label: "Jusqu'a 100 000" },
    { value: '100000-300000', label: '100 000 - 300 000' },
    { value: '300000-500000', label: '300 000 - 500 000' },
    { value: '500000-1000000', label: '500 000 - 1 000 000' },
    { value: '1000000+', label: 'Plus de 1 million' },
  ];
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-2xl p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <button onClick={handleSearch} className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3.5 px-8 rounded-lg transition-all duration-200 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl">
                  <Search size={20} />
