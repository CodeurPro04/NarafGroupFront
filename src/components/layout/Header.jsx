...
const Header = () => {
  ...
  const navGroups = useMemo(
    () => [
    {
      ...
      },
      {
        path: "/abi/club-abi",
        label: "Club Pro",
        description: "Retrouvez notre réseau et nos points de présence.",
        icon: Landmark
      }]
    ...
    },
    {
      ...
      icon: Search,
      summary:
      "Trouvez un bien, valorisez un patrimoine et accedez à une offre immobiliere structurée pour l'achat, la vente et la location.",
      children: [
      {
        path: "/properties",
        label: "Trouver un bien",
        description: "Parcourez les biens disponibles à la vente et à la location.",
        icon: Search
      },
      {
        path: "/register?role=proprietaire",
        label: "Devenir proprietaire",
        description: "Publiez vos offres et gerez votre espace dédié.",
        icon: Building2
      },
      {
        path: "/properties?transaction_type=vente",
        label: "Acheter",
        description: "Selectionnez les meilleures opportunités selon vos objectifs.",
        icon: WalletCards
      },
      {
        path: "/register?role=proprietaire",
        label: "Vendre",
        description: "Mettez votre bien sur le marché avec ABI.",
        icon: BadgeDollarSign
      },
      {
        path: "/properties?transaction_type=location",
        label: "Louer",
    ...
    },
    {
      ...
      icon: Hammer,
      summary:
      "Construisez, finalisez ou faites évoluer votre projet avec une offre plus complète, lisible et adaptée à chaque étape.",
      children: [
      {
        path: "/construction",
        label: "Nos offres",
        ...
        icon: Hammer,
        children: [
        { path: "/construction/offres/terrain-constructible", label: "Terrain constructible" },
        { path: "/construction/offres/maison-terrain", label: "Maison + Terrain" },
        { path: "/construction/offres/programme-en-cours", label: "Programme en cours" }]

      },
      {
        path: "/construction/mon-projet-sur-mesure",
        label: "Mon projet sur mesure",
        description: "Definissez un projet adapté à vos besoins et à votre budget.",
        icon: Pickaxe
      },
      {
      ...
      },
      {
        ...
        description: "Finalisez, rénovez ou transformez un chantier existant.",
        icon: ShieldCheck,
        children: [
        { path: "/construction/achever/finir-ma-construction", label: "Finir ma construction" },
        { path: "/construction/achever/renovation-modification", label: "Rénovation & Modification" }]
    ...
    },
    {
      ...
      icon: Briefcase,
      summary:
      "Analysez les opportunités, comprenez les parcours d'investissement et structurez une stratégie de placement claire avec ABI.",
      children: [
      {
        path: "/investment",
        label: "Nos offres",
        description: "Accedez aux opportunités d'investissement actuellement ouvertes.",
        icon: Briefcase
      },
      {
        ...
        icon: BadgeDollarSign,
        children: [
        { path: "/investment/je-veux-investir/pourquoi-investir", label: "Pourquoi investir" },
        { path: "/investment/je-veux-investir/investir-avec-abi", label: "Investir avec ABI" },
        { path: "/investment/je-veux-investir/premier-investissement", label: "Faire mon premier investissement" }]
      ...
      },
      {
        ...
        icon: Compass,
        children: [
        { path: "/investment/ou-investir/nos-conseils", label: "Nos conseils" },
        { path: "/investment/ou-investir/meilleurs-investissements", label: "Nos meilleurs investissements" }]
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-[#e5e7eb] bg-white shadow-[0_2px_14px_rgba(15,23,42,0.05)]">
      <div className="border-b border-[#b9daf5] bg-[#dff1ff]">
                          ...
                          <div className="flex items-start gap-4">
                            ...
                            <div className="min-w-0">
                              ...
                              <p className="mt-1 max-w-[360px] text-[14px] leading-6 text-[#757575]">
                                {child.description ||
                              "Accedez à cette rubrique pour explorer les contenus associes."}
                              </p>
                            </div>
                          </div>
                        </Link>
